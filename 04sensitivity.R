...
computeCost <- function(df,
  ...
  tc_amb  <- df_ex_Ambulatory*ambulatoryAvg
  tc_hosp <- df_ex_Hosp*costs$Hosp_charge_case
  tc_ED   <- df_ex_ED*costs$ED_charge_case
  ...
  serviceLost_1864 <-  df_ex_Hosp[adultInd,]*costs$LOS*HouseholdServiceLost
  if (methodIndirect=="friction"){
    friction <- df_ex_Hosp[adultInd,]*costs$LOS*ProdLost_1864 + 
      df_ex_Ambulatory[adultInd,]*daysAbsentAmb*ProdLost_1864
  ...
  secSchCost  <- SecSchCost*df_ex_Ambulatory[secSchInd,]*daysAbsentAmb + #lost in sch, amb
    ...
    PropChildCareGive*df_ex_Ambulatory[secSchInd,]*daysAbsentAmb*ProdLost_1864 +#caregiver lost, ambulatory
    PropChildCareGive*df_ex_Hosp[secSchInd,]*costs$LOS*ProdLost_1864 #caregiver lost, hospital
  
  elderlyCost <- PropElderCareGive*df_ex_Ambulatory[elderInd,]*ProdLost_1864*daysAbsentAmb + #caregiver lost, ambulatory
    PropElderCareGive*df_ex_Hosp[elderInd,]*ProdLost_1864*costs$LOS#caregiver lost, hospital
